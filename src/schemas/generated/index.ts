...
export const ClienteScalarFieldEnumSchema = z.enum([
  'id',
  'usuarioId',
  'nomeFantasia',
  'cpfOuCnpj',
...
export const PropostaScalarFieldEnumSchema = z.enum([
  'id',
  'mensagem',
  'valorProposto',
  'prazoEstimadoDias',
...
export const AvaliacaoScalarFieldEnumSchema = z.enum([
  'id',
  'nota',
  'comentario',
  'projetoId',
...
export const HabilidadeScalarFieldEnumSchema = z.enum([
  'id',
  'nome',
  'curriculoId',
]);

export const IdiomaScalarFieldEnumSchema = z.enum([
  'id',
  'nome',
  'nivel',
  'curriculoId',
...
export const ProjetoPortfolioScalarFieldEnumSchema = z.enum([
  'id',
  'nome',
  'descricao',
  'projectUrl',
...
export const NivelProficienciaSchema = z.enum([
  'BASICO',
  'INTERMEDIARIO',
  'AVANCADO',
  'ESPECIALISTA',
...
export type NivelProficienciaType =
  `${z.infer<typeof NivelProficienciaSchema>}`;
...
export const StatusPropostaSchema = z.enum([
  'ENVIADA',
  'EM_NEGOCIACAO',
  'ACEITA',
  'RECUSADA',
...
export const CurriculoSchema = z.object({
  ...
  valorHora: z
    .instanceof(Prisma.Decimal, {
      message:
        "Field 'valorHora' must be a Decimal. Location: ['Models', 'Curriculo']",
    })
    .nullable(),
...
export const PropostaSchema = z.object({
  ...
  id: z.string().cuid(),
  mensagem: z.string(),
  valorProposto: z.instanceof(Prisma.Decimal, {
    message:
      "Field 'valorProposto' must be a Decimal. Location: ['Models', 'Proposta']",
  }),
...
export type ExperienciaProfissional = z.infer<
