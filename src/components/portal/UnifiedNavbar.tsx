...
const freelancerLinks = [
  { href: '/projetos', label: 'Buscar Projetos', icon: Sparkles },
  { href: '/propostas', label: 'Minhas Propostas', icon: Send },
];

const clienteLinks = [
  { href: '/projetos', label: 'Projetos Criados', icon: Layers3 },
  { href: '/propostas', label: 'Propostas Recebidas', icon: Send },
